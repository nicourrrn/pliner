...
final desctopTheme = ThemeData(
  textTheme: TextTheme(
    bodySmall: _baseFont.copyWith(fontSize: 16, color: Colors.black),
    bodyMedium: _baseFont.copyWith(fontSize: 14, color: Colors.black54),
    bodyLarge: _baseFont.copyWith(fontSize: 18, color: Colors.black),
    titleSmall: _baseFont.copyWith(fontSize: 20, color: Colors.black),
    titleMedium: _baseFont.copyWith(fontSize: 22, color: Colors.black),
    titleLarge: _baseFont.copyWith(fontSize: 24, color: Colors.black),
    displaySmall: _baseFont.copyWith(fontSize: 26, color: Colors.black),
    displayMedium: _baseFont.copyWith(fontSize: 28, color: Colors.black),
    displayLarge: _baseFont.copyWith(fontSize: 30, color: Colors.black),
    headlineSmall: _baseFont.copyWith(fontSize: 32, color: Colors.black),
    headlineMedium: _baseFont.copyWith(fontSize: 34, color: Colors.black),
    headlineLarge: _baseFont.copyWith(fontSize: 36, color: Colors.black),
    labelSmall: _baseFont.copyWith(fontSize: 12, color: Colors.black),
    labelMedium: _baseFont.copyWith(fontSize: 14, color: Colors.black),
    labelLarge: _baseFont.copyWith(fontSize: 16, color: Colors.black),
  ),
